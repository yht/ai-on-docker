    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            **{
                ...
                "DB_HOST": os.getenv("DB_HOST", "psql"),                             # Database hostname
                ...
                "OLLAMA_HOST": os.getenv("OLLAMA_HOST", "http://llm:11434"),         # Make sure to update with the URL of your Ollama host, such as http://localhost:11434 or remote server address
                "TEXT_TO_SQL_MODEL": os.getenv("TEXT_TO_SQL_MODEL", "llama3.2:1b")   # Model to use for text-to-SQL generation
            }
        )
